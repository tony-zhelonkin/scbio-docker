...
> Deprecated Branch
>
> This branch (`dev-gpt-codex-integration`) is no longer maintained. AI integration is consolidated via the optional AI-enabled build and the external SciAgent‑toolkit.
>
